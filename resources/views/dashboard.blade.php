            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        <form class="row g-3 needs-validation" id="frm_searchSocialRazon" method='POST'>
                            @csrf
                            <label for="BSocialRazon" class="form-label">Buscar por razón social</label>
                            <input type="text" class="form-control" id="BSocialRazon" name="BSocialRazon" placeholder="Ingrese razón social" autocomplete="off">
                    ...
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 pb-1">
                                    <b>Razón Social:</b> <span class="badge bg-primary">{{ $ticket->client->SocialRasonRuc }}</span> 
                                </div>
                                <div class="col-md-4 pb-1">
                            ...
                            <div class="d-flex justify-content-end">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="col-auto">
                                        <a class="btn btn-outline-warning btn-sm mx-1" target="_blank" href="{{ url('/test') }}">PDF</a> 
                                    </div>
                                <div class="col-auto">
